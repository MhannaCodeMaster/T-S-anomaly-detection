...
def load_args():
    ...
    p.add_argument("--student.train", type=str, required=False, help="Train stdudent model")
    ...
    p.add_argument("--triplet.train", type=str, required=False, help="Train triplet model")
